...
mixin _$UserEntity {
 ...
 String get id; String get phone; UserRole get role; DateTime get createdAt; String? get name; double? get rating; int? get totalRatings; bool? get isVerified; UserSubscription? get subscription;
...
@override
String toString() {
  return 'UserEntity(id: $id, phone: $phone, role: $role, createdAt: $createdAt, name: $name, rating: $rating, totalRatings: $totalRatings, isVerified: $isVerified, subscription: $subscription)';
}
...
@useResult
$Res call({
 String id, String phone, UserRole role, DateTime createdAt, String? name, double? rating, int? totalRatings, bool? isVerified, UserSubscription? subscription
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String phone,  UserRole role,  DateTime createdAt,  String? name,  double? rating,  int? totalRatings,  bool? isVerified,  UserSubscription? subscription)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserEntity() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String phone,  UserRole role,  DateTime createdAt,  String? name,  double? rating,  int? totalRatings,  bool? isVerified,  UserSubscription? subscription)  $default,) {final _that = this;
switch (_that) {
case _UserEntity():
return $default(_that.id,_that.phone,_that.role,_that.createdAt,_that.name,_that.rating,_that.totalRatings,_that.isVerified,_that.subscription);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String phone,  UserRole role,  DateTime createdAt,  String? name,  double? rating,  int? totalRatings,  bool? isVerified,  UserSubscription? subscription)?  $default,) {final _that = this;
switch (_that) {
case _UserEntity() when $default != null:
return $default(_that.id,_that.phone,_that.role,_that.createdAt,_that.name,_that.rating,_that.totalRatings,_that.isVerified,_that.subscription);case _:
  return null;
...
class _UserEntity implements UserEntity {
  const _UserEntity({required this.id, required this.phone, required this.role, required this.createdAt, this.name, this.rating, this.totalRatings, this.isVerified, this.subscription});
