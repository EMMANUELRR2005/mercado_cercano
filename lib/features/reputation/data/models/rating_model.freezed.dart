...
@override
String toString() {
  return 'RatingModel(id: $id, vendorId: $vendorId, buyerId: $buyerId, stars: $stars, createdAt: $createdAt, comment: $comment)';
}
...
class _RatingModel extends RatingModel {
  const _RatingModel({required this.id, required this.vendorId, required this.buyerId, required this.stars, required this.createdAt, this.comment}): super._();
